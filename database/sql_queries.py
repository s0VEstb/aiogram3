...
UPDATE_DONATE_BALANCE_QUERY = """
UPDATE telegram_users SET BALANCE = COALESCE(BALANCE, 0) - ? WHERE TELEGRAM_ID = ?
"""


UPDATE_RECEPIENT_BALANCE_QUERY = """
UPDATE telegram_users SET BALANCE = COALESCE(BALANCE, 0) + ? WHERE TELEGRAM_ID = ?
"""


CREATE_DONATE_TABLE_QUERY = """
CREATE TABLE IF NOT EXISTS donate_table (
ID INTEGER primary key,
DONATE_TELEGRAM_ID INTEGER,
RECEPIENT_TELEGRAM_ID INTEGER,
BALANCE INTEGER
)"""


INSERT_DONATE_QUERY = """
INSERT INTO donate_table VALUES (?,?,?,?)
"""


SELECT_LIKED_PROFILES_QUERY = """
SELECT OWNER_ID FROM like_dislike WHERE LIKER_ID = ?
"""